 ...
 */
public class PointerControleur implements PointerIn {

    private final PointerVue vue;

    private final PointerIn interactor;

    public PointerControleur(Contexte contexte, PointerVue vue) {
        this.vue = vue;
        this.interactor = new PointerInteractor(contexte);
    }
